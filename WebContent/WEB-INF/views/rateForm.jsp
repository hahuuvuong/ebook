		...
		<div class="maincontent bg--white pt--80 pb--55">
			<div class="container">
				<div class="row">
					<div class="col border">
						<form>
							<div class="form-group">
								<div class="row m-2">
									<label for="exampleFormControlInput1">Đánh giá của bạn
										về sách ?</label>
								</div>
								<div class="row">
									<div class="rating">
										<span> <input type="radio" name="rating" id="str5"
											value="5"> <label for="str5"><i
												class="zmdi zmdi-star-outline"></i></label>
										</span> <span><input type="radio" name="rating" id="str4"
											value="4"><label for="str4"><i
												class="zmdi zmdi-star-outline"></i></label></span> <span><input
											type="radio" name="rating" id="str3" value="3"><i
											class="zmdi zmdi-star-outline"></i><label for="str3"></label></span>
										<span><input type="radio" name="rating" id="str2"
											value="2"><i class="zmdi zmdi-star-outline"></i><label
											for="str2"></label></span> <span><input type="radio"
											name="rating" id="str1" value="1"><i
											class="zmdi zmdi-star-outline"></i><label for="str1"></label></span>
									</div>
								</div>
							</div>
							<div class="form-group">
								<label for="titleAssessment">Tiêu đề của đánh giá </label>
								<textarea class="form-control" id="titleAssessment" rows="1"></textarea>
							</div>
							<div class="form-group">
								<label for="exampleFormControlTextarea1">Viết nhận xét
									của bạn</label>
					...
					<div class="col border">2 of 2</div>
				</div>
			</div>
		</div>
		<!-- //Header -->
