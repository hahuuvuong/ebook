									...
									<table class="table table-striped table-bordered first">
										...
										<tbody>
											<c:forEach var="u" items="${chapters}">
												<tr>
													<td style="width: 150px !important">${u.idChapter}</td>
													<td style="width: 150px !important">${u.idTruyen.idTruyen}</td>
													<td style="width: 175px !important">${u.tenChapter}</td>
													<td style="width: 750px!important">${u.noiDung}</td>
													<td style="width: 10% !important"><div
															class="dd-nodrag btn-group ml-auto">
															<a href = "updateChapter/${u.idChapter}.htm"><button class="btn btn-sm btn-outline-light">Edit</button></a>
															<a href = "deleteChapter/${u.idChapter}.htm"}><button class="btn btn-sm btn-outline-light">
