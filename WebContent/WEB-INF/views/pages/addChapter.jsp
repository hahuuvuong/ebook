							...
							<div class="card-body">
								<form:form action = "addchapter.htm" modelAttribute = "chapter" method="POST" class="needs-validation" >
								  ...
								  <c:if test = "${chapter.idChapter !=0}">
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
											<label for="validationCustom01">ID chapter</label> <form:input path="idChapter" type="text" readonly="true" class="form-control" id="validationCustom01" placeholder="Nhập tên truyện" />
											<div class="valid-feedback">Looks good!</div>
										</div>
										  </c:if>
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
											<label for="validationCustom01">Chọn truyện</label>
										<input value = "${idTruyen.idTruyen}" name = "idtTruyen"
												type="text" class="form-control" list="brow"
												placeholder="Nhập tên truyện" />
											<datalist id="brow">
												<c:forEach var="u" items = "${idTruyens}" >
												<option value="${u.idTruyen}">${u.tenTruyen}</option>
												</c:forEach>
											</datalist>
										</div> 
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
											<label for="validationCustom01">Tên chapter</label> <form:input path = "TenChapter"
